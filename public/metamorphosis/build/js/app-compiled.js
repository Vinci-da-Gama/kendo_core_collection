(function () {
	...
	var serv = ['appname.sig.service', 'appname.service', 'appname.promise.factory'];
	...
	*/
	...
	angular.module('appname.promise.factory', []);
...
(function () {
	var promiseM = angular.module('appname.promise.factory');
